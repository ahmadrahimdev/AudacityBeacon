...
const contractABI = require("../artifacts/contracts/Audacitybeacon.sol/Audacitybeacon.json").abi;

program
    .name("audacitybeacon-cli")
    .description("CLI tool for Audacitybeacon smart contract")
    .version("1.0.0");
